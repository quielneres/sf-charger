        ...
        <View style={styles.container}>
            ...
            <View style={styles.bottomMenu}>
                ...
                >
                    ...
                    />
                    <Text style={[styles.menuText, activeTab === 'map' && styles.activeText]}>
                        Mapa
                    </Text>
                </TouchableOpacity>
                ...
                >
                    ...
                    />
                    <Text style={[styles.menuText, activeTab === 'battery' && styles.activeText]}>
                        Bateria
                    </Text>
                </TouchableOpacity>
                ...
                >
                    ...
                    />
                    <Text style={[styles.menuText, activeTab === 'profile' && styles.activeText]}>
                        Perfil
                    </Text>
                </TouchableOpacity>
                ...
                >
                    ...
                    />
                    <Text style={[styles.menuText, activeTab === 'qr-code' && styles.activeText]}>
                        QR Code
                    </Text>
                </TouchableOpacity>
            </View>
